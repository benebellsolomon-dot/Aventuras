...
export function buildBeGenreRules(options: BeGenreRuleOptions): string {
  ...
  lines.push(
    ...
    'Commit discipline: when a growth directive appears, growth is already canon — render it in THIS response; do not defer it, soften it into metaphor, or leave it ambiguous. Between directives, never invent growth, shrinkage, or ambient size drift.',
