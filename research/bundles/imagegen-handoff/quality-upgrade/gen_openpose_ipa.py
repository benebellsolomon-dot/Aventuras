...
MANIFEST = r"D:\LLM\ComfyUI_windows_portable\quality-upgrade\openpose_ipa_manifest.json"
...
g["base_save"] = {"class_type": "SaveImage", "inputs": {"images": ["base_vd", 0], "filename_prefix": "OPIPA_base"}}
saves["base_save"] = {"body": BODY, "clothing": CLOTHING, "tier": BASE_TIER, "kind": "base", "label": "OPIPA_base"}
...
for t in TIERS:
    ...
    g[pfx + "_ipa"] = {"class_type": "IPAdapterAdvanced",
                       "inputs": {"model": m, "ipadapter": ["ipa_model", 0], "image": ["base_vd", 0],
    ...
    label = "OPIPA_%s_%s_t%d" % (BODY, CLOTHING, t)
